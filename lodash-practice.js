...
function reverseLodash(arr) {
  return _.reverse(arr);
}

console.log(reverseLodash([1, 2, 3]));

function without(arr, values) {
  return _.without(arr, values)
}

console.log(without(['zebra', 'lion', 'bear'], 'lion'));

function shuffle(arr) {
  return _.shuffle(arr)
}

console.log(shuffle([3, 2, 1, 8, 9]));
...
if (typeof describe === 'function') {
  ...
  describe('tail', () => {
    it('return an array without the first element', () => {
      const array = tail([1, 2, 3]);
      assert.deepEqual(
        array, [2, 3]
      );
    });
  ...
  describe('reverseLodash', () => {
    it('return a reversed array', () => {
      const array = reverseLodash([1, 2, 3]);
      assert.deepEqual(
        array, [3, 2, 1]
      );
    });
  ...
  describe('without', () => {
    it('return an array without a specified value', () => {
      const array = without([1, 2, 3], 2);
      assert.deepEqual(
        array, [1, 3]
      );
    });
  ...
  describe('shuffle', () => {
    it('return an array with each element at a different index', () => {
      const array = shuffle([1, 2, 3]);
      assert.notEqual(
        array[0], 1
      );
    });
